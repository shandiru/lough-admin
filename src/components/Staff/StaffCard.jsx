  ...
  return (
    <div className={`bg-white/70 backdrop-blur-md rounded-[28px] p-6 shadow-xl border transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 group ${
      ...
      <div className="flex flex-wrap gap-1.5 mb-4">
        <span className={`text-[9px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full ${isActive ? 'bg-emerald-100 text-emerald-600' : 'bg-amber-100 text-amber-500'}`}>

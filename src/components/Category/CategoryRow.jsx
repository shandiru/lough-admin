...
const CategoryRow = ({ category, onEdit, onDelete }) => {
  return (
    <tr className="group hover:bg-brand/5  transition-all duration-200">
      {/* Order */}
      <td className="px-8 py-6 whitespace-nowrap">
        <span className="inline-flex items-center justify-center w-9 h-9 rounded-xl bg-brand-soft/40  font-black text-brand text-sm">
      ...
      {/* Name */}
      <td className="px-8 py-6 whitespace-nowrap">
        <span className="font-black text-gray-900  text-base tracking-tight group-hover:text-brand transition-colors duration-200">
          {category.name}
        </span>
      </td>
      ...
      <td className="px-8 py-6 max-w-[240px]">
        <span className="text-gray-500  text-sm leading-relaxed line-clamp-2">
